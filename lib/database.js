...
function newTicketQuery( jTicket ) {
  var query = "INSERT INTO tickets (hash, title, author, email, create_date, department, description, priority, due_date) VALUES ( '" + jTicket.hash + "', '" + jTicket.title + "', '" + jTicket.submittedBy + "', '"
