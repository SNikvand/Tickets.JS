...
exports.emailclient = function emailclient(title, description, clientEmail, hash, baseURL) {
    ...
    var mailOptions = {
        ...
        text: "", // plaintext body
        html: "<b>Your submitted Ticket <br> Title:  </b>" +title + "<br> <b>description:</b> " + description + "<br><b>URL to view ticket: </b> "+ baseURL + hash  // html body
    }
