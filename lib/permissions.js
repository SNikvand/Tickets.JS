var adminPriv = ["overview", "viewtickets", "newticket", "searchtickets", "newuser", "viewusers", "newdept",
    "viewdepts", "mailsettings", "settings", "restrict"];
var managerPriv = ["overview", "viewtickets", "newticket", "searchtickets", "mailsettings", "settings", "restrict"];
var ituserPriv = ["overview", "viewtickets", "searchtickets", "mailsettings", "settings", "restrict"];
