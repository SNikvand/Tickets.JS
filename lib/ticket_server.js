...
/**
 * Handles set department requests by querying the database to create, modify, or add users to departments.
 * @param socket server socket to listen for messages
 * @author John Welker
 * @date 09/05/2014
 */
...
/**
 * queries the database to add a new ticket.
 ...
 * @param socket
 * @param ticket json object representing a ticket
 * @date 06/05/201
 * @author John Welker
 */
