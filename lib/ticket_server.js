...
function handleGetUsers(socket) {
    socket.on('getUsers', function(role) {
        ...
        // placeholder data
        var userList = [
            {firstname: "Mike", lastname: "Smith", username: "Msmith", email: "msmith@msmith.com", role: "Admin", dept: ["Finance", "Management"]},
            {firstname: "Rob", lastname: "Boss", username: "Rboss", email: "rboss@rboss.com", role: "IT User", dept: ["Accounting", "Waste"]}
        ]
...
function handleGetDepts(socket) {
    socket.on('getDepts', function() {
        ...
        // placeholder data
        var deptList = [
            {name: "Finances", manager: "Bob"},
            {name: "Info Tech", manager: "Miranda"},
            {name: "Waste Management", manager: "Jason"},
            {name: "Marketing", manager: "Robert"}
        ]
